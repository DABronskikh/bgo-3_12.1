...
import (
	"encoding/json"
	"fmt"
	"github.com/DABronskikh/bgo-3_11.1/cmd/bank/app/dto"
	"github.com/DABronskikh/bgo-3_11.1/pkg/card"
	"io/ioutil"
	"log"
	"net/http"
	"net/url"
...
func (s *Server) addCard(w http.ResponseWriter, r *http.Request) {
	...
	newCard, err := s.cardSvc.Add(params.UserId, params.Type, params.System)
